...
export const servicosDetalhes = {
  hero: {
    ...
    description:
      "Oferecemos uma gama completa de serviços de transporte e entrega para otimizar sua cadeia de suprimentos.",
  ...
  services: [
    ...
    },
    {
      ...
      description:
        "Operação dedicada para distribuição e entregas programadas, com roteirização inteligente, monitoramento em tempo real e foco em pontualidade. Levamos sua carga da origem ao destino com controle de janelas e comprovação digital da entrega.",
      imagePosition: "left" as const,
      features: [
        {
          icon: "mdi:map-marker-path",
          title: "Roteirização",
          description: "Roteiros otimizados para reduzir prazo e custo operacional",
        },
        {
          icon: "mdi:calendar-clock",
          title: "Janela de Entrega",
          description: "Cumprimento de horários críticos com equipe dedicada",
        },
        {
          icon: "mdi:file-check",
          title: "Comprovante Digital",
          description: "Confirmação de entrega com registro e rastreabilidade",
        },
      ],
      highlights: [
        {
        ...
        },
        {
          ...
          title: "POD",
          subtitle: "Prova de Entrega",
        },
      ],
      ctaText: "Falar sobre Entregas",
      ctaHref: "/cotacao?servico=entrega",
    },
    {
      id: "expresso",
